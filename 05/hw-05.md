<img width="1090" height="126" alt="image" src="https://github.com/user-attachments/assets/481b2ec5-daf7-4c9c-913e-93a251fd8c6b" /># Домашнее задание к занятию «Использование Terraform в команде»
...
CKV_YC_2: ВМ имеет публичный IP-адрес (нарушение безопасности — не должно быть публичного IP)

CKV_YC_11: К сетевому интерфейсу не назначена группа безопасности (отсутствует security group)
Check: CKV_YC_11: "Ensure security group is assigned to network interface."
	FAILED for resource: module.marketing_vm.yandex_compute_instance.this
	File: /modules/vm/main.tf:1-29
	Calling File: /main.tf:19-34
<img width="841" height="302" alt="image" src="https://github.com/user-attachments/assets/499a3e3e-e8e5-495e-8fcb-b115dba66acf" />
...
<img width="875" height="520" alt="image" src="https://github.com/user-attachments/assets/9dfc7e17-3640-4250-8e64-887995cb91a6" />
<img width="1335" height="340" alt="image" src="https://github.com/user-attachments/assets/37740393-1adc-41f7-9c94-e79b88dd90b8" />
<img width="880" height="225" alt="image" src="https://github.com/user-attachments/assets/d65a9e2c-7e7b-41eb-b1e9-798f97902833" />
...
https://github.com/Maratq/ter-homeworks/pull/1
------
### Задание 4
...
<img width="969" height="319" alt="image" src="https://github.com/user-attachments/assets/81cdc61d-9574-437e-91f6-a191196d6de4" />
<img width="1071" height="125" alt="image" src="https://github.com/user-attachments/assets/05c6cef8-1a7f-42af-b747-b010e9fc231d" />
<img width="1090" height="126" alt="image" src="https://github.com/user-attachments/assets/b765848f-e625-4bd3-81e0-aea2a564d888" />
